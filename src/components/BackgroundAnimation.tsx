const BackgroundAnimation = () => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {/* Gradient orbs */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-amber-500/[0.03] rounded-full blur-3xl blob" />
      <div className="absolute top-1/3 right-0 w-[400px] h-[400px] bg-orange-500/[0.02] rounded-full blur-3xl blob" />
      <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-amber-500/[0.02] rounded-full blur-3xl blob" />
      ...
      <div className="absolute inset-0">
        ...
        <div className="particle absolute top-[30%] left-[50%] w-1 h-1 bg-amber-500/20 rounded-full" />
        <div className="particle absolute top-[70%] right-[30%] w-1 h-1 bg-white/20 rounded-full" />
        <div className="particle absolute top-[50%] left-[80%] w-1.5 h-1.5 bg-amber-500/15 rounded-full" />
      </div>
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#1a1a1a]/50" />
    </div>
  );
};
